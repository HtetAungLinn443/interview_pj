...
@section('content')
    <div class="mb-5">
        ...
        <form action="{{ route('admin#categoryStore') }}" method="post" enctype="multipart/form-data" id="store-category">
            @csrf
            <div class="row ">
                <div class="px-5 col-md-6 col-12">
                    ...
                    <div class="mb-4 form-group">
                        ...
                        <input type="text" name="categoryName" class=" form-control" placeholder="Input Name" autofocus>
                    </div>
...
@endsection
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\CategoryStore'), 'store-category' !!}
    <script>
